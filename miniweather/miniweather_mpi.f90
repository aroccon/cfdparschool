program miniweather
  ...
  real(rp), parameter :: qpoints (nqpoints) = (/ 0.1127E0_rp , 0.5000E0_rp , 0.88729E0_rp /)
  real(rp), parameter :: qweights(nqpoints) = (/ 0.2779E0_rp , 0.4444E0_rp , 0.27777E0_rp /)
  ...
  integer , parameter :: nx_glob = 800              !Number of total grid cells in the x dimension
  integer , parameter :: nz_glob = 400              !Number of total grid cells in the z dimension
  real(rp), parameter :: sim_time = 10              !How many seconds to run the simulation
  real(rp), parameter :: output_freq = 100           !How frequently to output data to file (in seconds)
  integer , parameter :: data_spec_int = 5          !How to initialize the data
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
