...
program miniweather
  ...
  integer , parameter :: data_spec_int = 6  !How to initialize the data (from 1 to 6)
  ...
  integer :: filenum=0   
  integer(4) :: device=1                       !For counting output
  ...
  call acc_set_device_num(device,acc_device_nvidia)
  call init(dt)
